...
This EIP defines standard functions for granular approval of [EIP-1155](./eip-1155.md) tokens by both `id` and `amount`. This EIP extends [EIP-1155](./eip-1155.md). This EIP extends [EIP-1155](./eip-1155.md). This EIP extends [EIP-1155](./eip-1155.md).
...
The name "EIP-1155 Approval By Amount Extension" was chosen because it is a succinct description of this EIP. Users can approve their tokens by `id` and `amount` to `operator`s. Users can approve their tokens by `id` and `amount` to `operator`s. Users can approve their tokens by `id` and `amount` to `operator`s.
