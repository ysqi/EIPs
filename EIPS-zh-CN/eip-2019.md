...
* Funding and payment traceability is enhanced bringing the initiation into the ledger. Funding and payment traceability is enhanced bringing the initiation into the ledger. All payment stat s can be stored on chain. Funding and payment traceability is enhanced bringing the initiation into the ledger. All payment stat s can be stored on chain.
