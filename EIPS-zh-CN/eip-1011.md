...
* When applying `vote` transactions to `CASPER_ADDR` to vm state:
  ...
  * Do not count gas of `vote` toward the normal `gas_used`. Do not count gas of `vote` toward the normal `gas_used`. For all `vote` transaction receipts, cumulative gas used is equal to last non-`vote` transaction receipt Do not count gas of `vote` toward the normal `gas_used`. For all `vote` transaction receipts, cumulative gas used is equal to last non-`vote` transaction receipt
