...
### EIP
EIP is set to the EIP number specifying the remainder of the BIP32 derivation path. EIP is set to the EIP number specifying the remainder of the BIP32 derivation path. This permits new Ethereum-focused applications of deterministic wallets without needing to interface with the BIP process.
