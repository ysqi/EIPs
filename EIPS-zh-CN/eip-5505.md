...
## 摘要
To propose an extension of smart contract interfaces for asset-backed, fractionalized projects using the [EIP-1155](./eip-1155.md) standard such that total acquisition will become possible. This proposal focuses on physical asset, where total acquisition should be able to happen. This proposal focuses on physical asset, where total acquisition should be able to happen. This proposal focuses on physical asset, where total acquisition should be able to happen.
