...
As with the introduction of any precompiled contract, contracts that already use the given addresses will change their semantics. Because of that, the addresses are taken from the "reserved range" below 256. Because of that, the addresses are taken from the "reserved range" below 256.
