...
**Approach D:** Equally strong, the metadata can make a normal reference (no integrity protection) to the schema and on-chain data also includes a hash of the schema document. In this approach, changing the metadata document will require updating on-chain `tokenURIIntegrity` and updating the schema document will require updating the `tokenURISchemaIntegrity`: In this approach, changing the metadata document will require updating on-chain `tokenURIIntegrity` and updating the schema document will require updating the `tokenURISchemaIntegrity`:
...
4. W3C Subresource Integrity (SRI). https://www.w3.org/TR/SRI/ https://www.w3.org/TR/SRI/
5. The "data" URL scheme. https://tools.ietf.org/html/rfc2397 https://tools.ietf.org/html/rfc2397
6. Uniform Resource Identifier (URI): Generic Syntax. https://tools.ietf.org/html/rfc3986 https://tools.ietf.org/html/rfc3986
7. CID \[Specification\] (DRAFT). CID \[Specification\] (DRAFT). https://github.com/multiformats/cid
...
3. [320 byte file] The second SHA Collision. https://privacylog.blogspot.com/2019/12/the-second-sha-collision.html https://privacylog.blogspot.com/2019/12/the-second-sha-collision.html
