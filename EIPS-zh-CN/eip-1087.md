...
The following changes are made to the EVM:
 ...
 - When a storage slot's value is changed for the first time, the slot is marked as dirty. When a storage slot's value is changed for the first time, the slot is marked as dirty. If the slot was previously set to 0, 20000 gas is deducted; otherwise, 5000 gas is deducted.
