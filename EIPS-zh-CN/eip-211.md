...
Pushes the size of the return data buffer onto the stack. Pushes the size of the return data buffer onto the stack. Gas costs: 2 (same as `CALLDATASIZE`) Pushes the size of the return data buffer onto the stack. Gas costs: 2 (same as `CALLDATASIZE`)
