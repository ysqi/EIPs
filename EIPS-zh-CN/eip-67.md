...
Clicking this link would open a transaction that would try to send _5 unicorns_ to address _deadbeef_. The user would then simply approve, based on each wallet UI. The user would then simply approve, based on each wallet UI. The user would then simply approve, based on each wallet UI. The user would then simply approve, based on each wallet UI.
