...
A ReCap URI starts with `urn:recap:` followed by the namespace discriminator, followed by `:` and the base64url-encoded payload of the ReCap Details Object. Note, the term base64url is defined in RFC4648 - Base 64 Encoding with URL and Filename Safe Alphabet. Note, the term base64url is defined in RFC4648 - Base 64 Encoding with URL and Filename Safe Alphabet.
...
- [Optional] Let `statement` be the statement field of the input SIWE message conforming to EIP-4361. Algorithm: Algorithm:
...
- Let `siwe-signature` be the output of signing `recap-siwe`, as defined in EIP-4361. Algorithm: Algorithm:
