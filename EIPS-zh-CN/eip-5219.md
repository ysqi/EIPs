...
The `request` method was chosen to be readonly because all data should be sent to the contract from the parsed DApp. Here are some reasons why: Here are some reasons why: Here are some reasons why:
