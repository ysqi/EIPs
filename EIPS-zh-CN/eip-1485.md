...
#### 1. 1. Reference materials on ETHASH FNV0
...
#### 2. 2. Current applied Ethash FNV hash implementation is deprecated now.
...
[FNV-0_hash (deprecated)](https://en.wikipedia.org/wiki/Fowler%E2%80%93Noll%E2%80%93Vo_hash_function#FNV-0_hash_(deprecated))
  ...
  When analysed FNV-0 , there's very weak [avalanche effect](https://simple.wikipedia.org/wiki/Avalanche_effect), when hash input changes on 1~2bits. refer [FNV-Analysis reference section](https://github.com/tao-foundation/FNV-Analysis#how-to-test-and-analysis-reference-test-code) refer [FNV-Analysis reference section](https://github.com/tao-foundation/FNV-Analysis#how-to-test-and-analysis-reference-test-code)

  We need to research and apply newer FNV hash or short message hash algorithm.

#### 3. 3. FNV1A hash algorithm description
...
FNV_offset_basis and computation order change of xor and multiplication Makes one more xor and multiply computation, but more secure hash effects than FNV0. and make dispersion boundary condition (0, even number, ..) by using of Prime Number. and make dispersion boundary condition (0, even number, ..) by using of Prime Number.

#### 4. 4. Real Implementation for FNV1A
...
#### 5. 5. [FNV-Analysis](https://github.com/tao-foundation/FNV-Analysis)
FNV Mix Algorithm Analysis for TEthashV1

#### How to test and analysis reference test code.

You can compile it with simple in terminal. No additional library needs, You can compile it with simple in terminal. No additional library needs, No additional library needs,
