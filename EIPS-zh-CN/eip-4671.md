...
* An address might possess multiple tokens. An address might possess multiple tokens. Each token has a unique identifier: `tokenId`. An address might possess multiple tokens. Each token has a unique identifier: `tokenId`. An address might possess multiple tokens. Each token has a unique identifier: `tokenId`.
