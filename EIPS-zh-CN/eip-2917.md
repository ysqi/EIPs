...
By standardizing ERC2917, it abstracts the interface for interests generation process. By standardizing ERC2917, it abstracts the interface for interests generation process. Making wallet applications easier to collect each DeFi's metrics, user friendlier. By standardizing ERC2917, it abstracts the interface for interests generation process. Making wallet applications easier to collect each DeFi's metrics, user friendlier.
...
This emit when interests amount per block is changed by the owner of the contract. It emits with the old interests amount and the new interests amount. This emit when interests amount per block is changed by the owner of the contract. It emits with the old interests amount and the new interests amount. It emits with the old interests amount and the new interests amount.
...
It returns user's productivity and overall productivity. It returns user's productivity and overall productivity. It returns 0 if user has no productivity proved in the contract.
...
### mint
it mints the amount of interests will transfer to callee's address. It returns the amount of interests minted. It returns the amount of interests minted.
