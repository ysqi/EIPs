...
By standardizing ERC2917, it abstracts the interface for interests generation process. By standardizing ERC2917, it abstracts the interface for interests generation process. Making wallet applications easier to collect each DeFi's metrics, user friendlier.
...
This emit when interests amount per block is changed by the owner of the contract. It emits with the old interests amount and the new interests amount. It emits with the old interests amount and the new interests amount.
