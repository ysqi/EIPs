...
This standard is an extension of [EIP-1155](./eip-1155.md). This standard is an extension of [EIP-1155](./eip-1155.md). It proposes an additional role (`user`) which can be granted to addresses that represent a `user` of the assets rather than an `owner`.
