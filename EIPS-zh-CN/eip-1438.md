...
#### 1.2. 1.2. Upload asset & user data
The avatar's information & assets are stored in the event log part of the block chain.
- Assets are SVG format. (compressed with gzip) (compressed with gzip)
...
### 2. 2. Universal Wallet
![wallet](/assets/eip-1438/wallet.png)
#### 2.1. 2.1. ERC20 interface
``` js
...
#### 2.2. 2.2. Fixed ERC20 contract for receive approval and execute function in one call
``` js
...
#### 2.3. 2.3. And ApproveAndCallFallBack contract for Fixed ERC20.
