...
| `security_level` | Security level measured in bits. Security level measured in bits. Denoted `M` in the Poseidon paper Security level measured in bits. Denoted `M` in the Poseidon paper | 2                        |          |
| `alpha`          | Power of S-box                                                                                                                                                         | 1                        |          |
| `input_rate`     | Size of input                                                                                                                                                          | 2                        |          |
| `t`              | Size of the state                                                                                                                                                      | 1                        |          |
| `full_round`     | Number of full rounds. Number of full rounds. Number of full rounds. Denoted as `R_F` in the Poseidon paper.                                                           | 1                        |          |
| `partial_round`  | Number of partial rounds. Number of partial rounds. Number of partial rounds. Denoted as `R_P` in the Poseidon paper.                                                  | 1                        |          |
...
The matrix must be chosen s.t. The matrix must be chosen s.t. The matrix must be chosen s.t. no subspace trail with inactive/active S-boxes can be set up for more than `t -1` rounds.
