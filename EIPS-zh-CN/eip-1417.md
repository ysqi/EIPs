...
1. We have created a couple of implementations of polls for varied use cases. Please refer to them [here](https://github.com/chaitanyapotti/Voting) Please refer to them [here](https://github.com/chaitanyapotti/Voting)
...
The 0.4.24 Solidity interface grammar is not expressive enough to document the ERC-1417 standard. A contract which complies with ERC-1417 MUST also abide by the following: A contract which complies with ERC-1417 MUST also abide by the following:
