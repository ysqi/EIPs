...
1. `Object` - The transaction object
  ...
  * `nonce`: `QUANTITY` - (optional) Integer of a nonce. This allows to overwrite your own pending transactions that use the same nonce. This allows to overwrite your own pending transactions that use the same nonce.
