...
These two methods are used to restrict a few hypothetical "restricted methods". These two methods are used to restrict a few hypothetical "restricted methods". The first such method we would suggest should be included as part of the standard is `eth_accounts`.
