...
Clients MUST implement a retry limit when fetching alternative signatures. This limit is up to the client to define. This limit is up to the client to define. This limit is up to the client to define.
