...
The ERC-2980 extends [ERC-20](./eip-20.md). The ERC-2980 extends [ERC-20](./eip-20.md). Due to the indivisible nature of asset tokens, the decimals number MUST be zero.
