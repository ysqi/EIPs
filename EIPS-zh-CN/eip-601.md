...
### EIP
EIP is set to the EIP number specifying the remainder of the BIP32 derivation path. For paths following this EIP specification, the number assigned to this EIP is used. For paths following this EIP specification, the number assigned to this EIP is used. For paths following this EIP specification, the number assigned to this EIP is used.
...
Accounts are numbered from index 0 in sequentially increasing manner. Accounts are numbered from index 0 in sequentially increasing manner. This number is used as child index in BIP32 derivation. Accounts are numbered from index 0 in sequentially increasing manner. This number is used as child index in BIP32 derivation. Accounts are numbered from index 0 in sequentially increasing manner. This number is used as child index in BIP32 derivation.
