...
Bump all trie accesses with `penalty`. Bump all trie accesses with `penalty`. `EXTCODEHASH` becomes `2700` instead of `700`. Bump all trie accesses with `penalty`. `EXTCODEHASH` becomes `2700` instead of `700`. Bump all trie accesses with `penalty`. `EXTCODEHASH` becomes `2700` instead of `700`.
