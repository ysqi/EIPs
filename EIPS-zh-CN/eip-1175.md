...
### Methods
#### createWallet
Create wallet contract and add to list. Returns the address of new wallet. Create wallet contract and add to list. Returns the address of new wallet. Create wallet contract and add to list. Returns the address of new wallet. Returns the address of new wallet.
...
#### createShop
Create Shop contract and add to list. Create Shop contract and add to list. Returns the address of new Shop with erc20 token address. Create Shop contract and add to list. Returns the address of new Shop with erc20 token address.
...
#### payCancel
Cancel pay and refund. (only weekly model) Cancel pay and refund. (only weekly model) Cancel pay and refund. (only weekly model) (only weekly model)
``` js
...
## Shop
Shop is created by wallet center or not. Shop is created by wallet center or not. but Shop that created by wallet center is called safe shop. Shop is created by wallet center or not. but Shop that created by wallet center is called safe shop. Shop is created by wallet center or not. but Shop that created by wallet center is called safe shop.
### Methods
#### balanceOf
...
#### update
Update item state for sell. Update item state for sell. (change item `_price` or add item `_stock`) Update item state for sell. (change item `_price` or add item `_stock`) Update item state for sell. (change item `_price` or add item `_stock`)
``` js
