...
Types can also use existing types in their composition. Types can also use existing types in their composition. However, this will always result in a directed acyclic graph.
