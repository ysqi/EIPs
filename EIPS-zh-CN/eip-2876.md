...
## Simple Summary
This ERC defines a simple contract interface for managing deposits. This ERC defines a simple contract interface for managing deposits. It also defines a new address format that encodes the extra data passed into the interface's main deposit function.
