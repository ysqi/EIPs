...
The `operationId` is a competitive resource. It is recommended, but nor required, that the hold issuers used a unique prefix to avoid collisions. It is recommended, but nor required, that the hold issuers used a unique prefix to avoid collisions.
