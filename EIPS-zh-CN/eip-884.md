...
It is not desirable that anyone can add, remove, update, or supersede verified addresses. How access to these functions is controlled is outside of the scope of this standard. How access to these functions is controlled is outside of the scope of this standard. How access to these functions is controlled is outside of the scope of this standard.
