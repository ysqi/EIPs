...
2. `section_kind` MUST NOT be `0`. `section_kind` MUST NOT be `0`. The value `0` is reserved for *section headers terminator byte*. `section_kind` MUST NOT be `0`. The value `0` is reserved for *section headers terminator byte*.
