...
Here are alternate specs loosely based on Gnosis prediction market contracts v1. Reality Check also exposes a similar endpoint (`getFinalAnswer`). Reality Check also exposes a similar endpoint (`getFinalAnswer`).
