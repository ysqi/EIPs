...
|  | Client       | Language | libsodium binding                                                 | |  | ------------ | -------- | ----------------------------------------------------------------- | |  | Geth         | Go       | use cgo with C [libsodium](https://github.com/jedisct1/libsodium) | |  | Parity       | Rust     | [sodiumoxide](https://github.com/dnaq/sodiumoxide)                | |  | PyEthereum   | Python   | [PyNaCl](https://github.com/pyca/pynacl)                          |
