...
`ECRECOVER` has a gas cost of 3000. Since Ed25519 is computationally cheaper, the gas price should be less. Since Ed25519 is computationally cheaper, the gas price should be less.
...
|  | ------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  | Geth         | Go       | |  | Client       | Language | libsodium binding                                                 | |  | ------------ | -------- | ----------------------------------------------------------------- | |  | Geth         | Go       | use cgo with C [libsodium](https://github.com/jedisct1/libsodium) | |  | Parity       | Rust     | [sodiumoxide](https://github.com/dnaq/sodiumoxide)                | |  | PyEthereum   | Python   | [PyNaCl](https://github.com/pyca/pynacl)                          | |
