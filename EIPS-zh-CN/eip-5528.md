...
- *Payable Contract*: The sellers and buyers use this token to fund the *Escrow Contract*. This contract MUST override [EIP-20](./eip-20.md) interfaces. This contract MUST override [EIP-20](./eip-20.md) interfaces. This contract MUST override [EIP-20](./eip-20.md) interfaces. This contract MUST override [EIP-20](./eip-20.md) interfaces.
- *Escrow Contract*: Defines the escrow policies and holds *Payable Contract*'s token for a certain period. This contract does not requires override [EIP-20](./eip-20.md) interfaces. This contract does not requires override [EIP-20](./eip-20.md) interfaces. This contract does not requires override [EIP-20](./eip-20.md) interfaces. This contract does not requires override [EIP-20](./eip-20.md) interfaces.
...
`escrowFund` send tokens to the *Escrow Contract*. `escrowFund` send tokens to the *Escrow Contract*. `escrowFund` send tokens to the *Escrow Contract*. The *Escrow Contract* can hold the contract in the escrow process or reject tokens if the policy does not meet. `escrowFund` send tokens to the *Escrow Contract*. `escrowFund` send tokens to the *Escrow Contract*. The *Escrow Contract* can hold the contract in the escrow process or reject tokens if the policy does not meet.
