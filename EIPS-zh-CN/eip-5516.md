...
This EIP supports transfers to multiple recipients. This EIP supports transfers to multiple recipients. This eases token transfer to a large number of addresses, making it more gas-efficient and user-friendly.
