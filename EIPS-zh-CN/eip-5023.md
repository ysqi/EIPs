...
Reference implementation should not be used as is in production. Reference implementation should not be used as is in production. There are no other security considerations related directly to implementation of this standard.
