...
## Implementation
There is a various choice of existing implementations of the curve operations. It may require extra work to add an ABI: It may require extra work to add an ABI:
