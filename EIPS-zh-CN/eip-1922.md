...
_x_ or `inputs` - A vector of 'Public Inputs'. A public argument to the circuit _C_ which, when combined with the private witness string _w_, comprises an argument of knowledge which satisfies the circuit _C_. A public argument to the circuit _C_ which, when combined with the private witness string _w_, comprises an argument of knowledge which satisfies the circuit _C_.
...
#### `verify`
The `verify` function forms the crux this standard. The `verify` function forms the crux this standard. The parameters are intended to be as generic as possible, to allow for verification of any zk-SNARK:
...
##### Notable applications of zk-SNARKs
 ...
 1. Zcash. How Transactions Between Shielded Addresses Work. Zcash. How Transactions Between Shielded Addresses Work. https://blog.z.cash/zcash-private-transactions/
...
##### Notable projects relating to zk-SNARKs
  ...
  1. ZoKrates: Scalable Privacy-Preserving Off-Chain Computations. https://www.ise.tu-berlin.de/fileadmin/fg308/publications/2018/2018_eberhardt_ZoKrates.pdf https://www.ise.tu-berlin.de/fileadmin/fg308/publications/2018/2018_eberhardt_ZoKrates.pdf
  1. ZoKrates Project Repository. https://github.com/JacobEberhardt/ZoKrates https://github.com/JacobEberhardt/ZoKrates
